...
tools: ['codebase', 'extensions', 'fetch', 'githubRepo', 'problems', 'search', 'searchResults', 'usages', 'vscodeAPI', 'createFile', 'readFile', 'runSubagent', 'changes', 'edit/editFiles', 'fetch', 'githubRepo', 'search']
---
